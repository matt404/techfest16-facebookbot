...
function getDomainSpins(senderID, domainSearch, callbackFn){
  var pagesize = 7;
  var domainSpinQS = "pagestart=0&pagesize="+pagesize+"&q="+encodeURI(domainSearch)+"&key=dpp_search";
...
function receivedMessage(event) {
  ...
  var userName = event.sender.name;

  console.log("Received message from userId %d userName %s for recipientId %d at %d with message:",
    senderID, userName, recipientID, timeOfMessage);
